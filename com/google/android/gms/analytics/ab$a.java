...
class ab$a extends SQLiteOpenHelper
{
  ...
  ab$a(ab paramab, Context paramContext, String paramString)
  {
  ...
  private boolean a(String paramString, SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    //   1: astore_3
    //   2: iconst_1
    //   3: anewarray 85	java/lang/String
    //   6: astore 9
    //   8: aload 9
    //   10: iconst_0
    //   11: ldc 87
    //   13: aastore
    //   14: iconst_1
    //   15: anewarray 85	java/lang/String
    //   18: astore 10
    //   20: aload 10
    //   22: iconst_0
    //   23: aload_1
    ...
    //   35: aconst_null
    //   36: aconst_null
    //   37: invokevirtual 95	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   40: astore 11
    //   42: aload 11
    //   44: invokeinterface 98 1 0
    //   49: istore 13
    //   51: iload 13
    //   53: istore 8
    //   55: aload 11
    ...
    //   82: ldc 103
    //   84: invokevirtual 107	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   87: aload_1
    ...
    //   94: invokestatic 116	com/google/android/gms/analytics/z:W	(Ljava/lang/String;)V
    //   97: aload 6
    //   99: ifnull +10 -> 109
    //   102: aload 6
  ...
  {
    if ((this.Bf) && (3600000L + this.Bg > ab.a(this.Bh).currentTimeMillis()))
      throw new SQLiteException("Database creation failed");
    Object localObject = null;
    this.Bf = true;
    this.Bg = ab.a(this.Bh).currentTimeMillis();
    try
    {
    ...
    {
      while (true)
        ab.c(this.Bh).getDatabasePath(ab.b(this.Bh)).delete();
    }
  }
 ...
 * Qualified Name:     com.google.android.gms.analytics.ab.a
