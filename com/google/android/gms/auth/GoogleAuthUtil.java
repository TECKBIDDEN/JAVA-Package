...
public final class GoogleAuthUtil
{
    ...
    throws GooglePlayServicesAvailabilityException, GoogleAuthException, IOException
  {
    ...
    //   4: astore_2
    //   5: ldc 241
    //   7: invokestatic 246	com/google/android/gms/common/internal/n:aU	(Ljava/lang/String;)V
    //   10: aload_2
    //   11: invokestatic 247	com/google/android/gms/auth/GoogleAuthUtil:D	(Landroid/content/Context;)V
    //   14: new 126	android/os/Bundle
    //   17: dup
    //   18: invokespecial 127	android/os/Bundle:<init>	()V
    //   21: astore_3
    //   22: aload_0
    ...
    //   39: aload_3
    //   40: getstatic 51	com/google/android/gms/auth/GoogleAuthUtil:KEY_ANDROID_PACKAGE_NAME	Ljava/lang/String;
    //   43: invokevirtual 261	android/os/Bundle:containsKey	(Ljava/lang/String;)Z
    //   46: ifne +12 -> 58
    //   49: aload_3
    //   50: getstatic 51	com/google/android/gms/auth/GoogleAuthUtil:KEY_ANDROID_PACKAGE_NAME	Ljava/lang/String;
    //   53: aload 4
    ...
    //   65: astore 5
    //   67: aload_2
    //   68: getstatic 81	com/google/android/gms/auth/GoogleAuthUtil:Dp	Landroid/content/Intent;
    //   71: aload 5
    //   73: iconst_1
    //   74: invokevirtual 268	android/content/Context:bindService	(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    //   77: ifeq +107 -> 184
    //   80: aload 5
    //   82: invokevirtual 272	com/google/android/gms/common/a:fX	()Landroid/os/IBinder;
    ...
    //   115: ifne +49 -> 164
    //   118: new 88	com/google/android/gms/auth/GoogleAuthException
    //   121: dup
    //   122: aload 11
    //   124: invokespecial 117	com/google/android/gms/auth/GoogleAuthException:<init>	(Ljava/lang/String;)V
    //   127: athrow
    //   128: astore 8
    //   130: ldc_w 296
    //   133: ldc_w 298
    ...
    //   141: pop
    //   142: new 120	java/io/IOException
    //   145: dup
    //   146: ldc_w 306
    ...
    //   170: return
    //   171: astore 6
    //   173: new 88	com/google/android/gms/auth/GoogleAuthException
    //   176: dup
    //   177: ldc_w 313
    //   180: invokespecial 117	com/google/android/gms/auth/GoogleAuthException:<init>	(Ljava/lang/String;)V
    //   183: athrow
    //   184: new 120	java/io/IOException
    //   187: dup
    //   188: ldc_w 315
    ...
    throws GoogleAuthException, IOException
  {
    ...
    //   0: aload_2
    //   1: ldc_w 319
    //   4: invokestatic 322	com/google/android/gms/common/internal/n:b	(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
    //   7: pop
    //   8: ldc 241
    //   10: invokestatic 246	com/google/android/gms/common/internal/n:aU	(Ljava/lang/String;)V
    //   13: aload_0
    ...
    //   31: astore 5
    //   33: aload 4
    //   35: getstatic 81	com/google/android/gms/auth/GoogleAuthUtil:Dp	Landroid/content/Intent;
    //   38: aload 5
    //   40: iconst_1
    //   41: invokevirtual 268	android/content/Context:bindService	(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    //   44: ifeq +96 -> 140
    //   47: aload 5
    //   49: invokevirtual 272	com/google/android/gms/common/a:fX	()Landroid/os/IBinder;
    ...
    //   103: pop
    //   104: new 120	java/io/IOException
    //   107: dup
    //   108: ldc_w 306
    ...
    //   126: athrow
    //   127: astore 6
    //   129: new 88	com/google/android/gms/auth/GoogleAuthException
    //   132: dup
    //   133: ldc_w 313
    //   136: invokespecial 117	com/google/android/gms/auth/GoogleAuthException:<init>	(Ljava/lang/String;)V
    //   139: athrow
    //   140: new 120	java/io/IOException
    //   143: dup
    //   144: ldc_w 315
    ...
    throws IOException, UserRecoverableAuthException, GoogleAuthException
  {
    ...
    //   4: astore 4
    //   6: ldc 241
    //   8: invokestatic 246	com/google/android/gms/common/internal/n:aU	(Ljava/lang/String;)V
    //   11: aload 4
    //   13: invokestatic 247	com/google/android/gms/auth/GoogleAuthUtil:D	(Landroid/content/Context;)V
    //   16: aload_3
    //   17: ifnonnull +125 -> 142
    //   20: new 126	android/os/Bundle
    //   23: dup
    //   24: invokespecial 127	android/os/Bundle:<init>	()V
    //   27: astore 5
    //   29: aload_0
    ...
    //   55: ifne +13 -> 68
    //   58: aload 5
    //   60: getstatic 51	com/google/android/gms/auth/GoogleAuthUtil:KEY_ANDROID_PACKAGE_NAME	Ljava/lang/String;
    //   63: aload 6
    ...
    //   75: astore 7
    //   77: aload 4
    //   79: getstatic 81	com/google/android/gms/auth/GoogleAuthUtil:Dp	Landroid/content/Intent;
    //   82: aload 7
    //   84: iconst_1
    //   85: invokevirtual 268	android/content/Context:bindService	(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    //   88: ifeq +188 -> 276
    //   91: aload 7
    //   93: invokevirtual 272	com/google/android/gms/common/a:fX	()Landroid/os/IBinder;
    ...
    //   173: checkcast 69	android/content/Intent
    //   176: astore 16
    //   178: aload 15
    //   180: invokestatic 374	com/google/android/gms/auth/GoogleAuthUtil:ax	(Ljava/lang/String;)Z
    //   183: ifeq +52 -> 235
    //   186: new 124	com/google/android/gms/auth/UserRecoverableAuthException
    //   189: dup
    //   190: aload 15
    //   192: aload 16
    ...
    //   211: pop
    //   212: new 120	java/io/IOException
    //   215: dup
    //   216: ldc_w 306
    ...
    //   240: ifeq +26 -> 266
    //   243: new 120	java/io/IOException
    //   246: dup
    //   247: aload 15
    //   249: invokespecial 307	java/io/IOException:<init>	(Ljava/lang/String;)V
    //   252: athrow
    //   253: astore 8
    //   255: new 88	com/google/android/gms/auth/GoogleAuthException
    //   258: dup
    //   259: ldc_w 313
    //   262: invokespecial 117	com/google/android/gms/auth/GoogleAuthException:<init>	(Ljava/lang/String;)V
    //   265: athrow
    //   266: new 88	com/google/android/gms/auth/GoogleAuthException
    //   269: dup
    //   270: aload 15
    //   272: invokespecial 117	com/google/android/gms/auth/GoogleAuthException:<init>	(Ljava/lang/String;)V
    //   275: athrow
    //   276: new 120	java/io/IOException
    //   279: dup
    //   280: ldc_w 315
